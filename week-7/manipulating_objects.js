...
// What tests did you have trouble passing? It took a while to figure out the convention for
//assigning nested objects.
//What did you do to make it pass? Why did that work? I finally understood that althouh nested,
//the assigning conventions work the same way; they're just set in layers, so for carter property in children
//property, I  just add .carter to terah.children to create it. Then the assignment of the carter property works
//the same way.
//How difficult was it to add and delete properties outside of the object itself? After I understood
//what to do, not so difficult.
//What did you learn about manipulating objects in this challenge? I learned that you can add, delete, and manipulate properties
//at any point in the code by calling up the specific property of the objects.
//
//
//
//
