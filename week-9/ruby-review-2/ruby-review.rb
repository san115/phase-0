...
spoon.eat
puts spoon.clean #=> this should be false to remove") unless silverware_drawer.contents.include?(spoon)
silverware_drawer.remove_item(spoon) #What is happening when you run this the first time?
spoon.eat
...
# Reflection
# What concepts did you review in this challenge? I reviewed classes, methods in classes and driver codes
# What is still confusing to you about Ruby?  More than confusing, I think I need a review of the general concepts.
# What are you going to study to get more prepared for Phase 1? I'd like to do a general revie wof all the concepts.